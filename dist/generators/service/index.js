...
module.exports = generators.Base.extend({
  ...
  initializing: function initializing(name) {
    var done = this.async();
  ...
  writing: function writing() {
    ...
    this.fs.copyTpl(this.templatePath(this.props.type + '-service.js'), this.destinationPath('src/services', this.props.name, 'index.js'), this.props);
    ...
    this.fs.copyTpl(this.templatePath('hooks.js'), this.destinationPath('src', 'services', this.props.name, 'hooks', 'index.js'), this.props);

    this.fs.copyTpl(this.templatePath('index.test.js'), this.destinationPath('test', 'services', this.props.name, 'index.test.js'), this.props);
