...
module.exports = generators.Base.extend({
  ...
  writing: function writing() {
    ...
    // copy the hook
    this.fs.copyTpl(this.templatePath('hook.js'), this.destinationPath(this.props.hookPath), this.props);

    // copy the hook test
    this.fs.copyTpl(this.templatePath('hook.test.js'), this.destinationPath(this.props.hookTestPath), this.props);
  }
});